...
<noscript><div><img src="https://mc.yandex.ru/watch/64713664" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
</head>
<body>
    <div class="container">
           ...
           <div class="wrap">
               <div class="wrap_float">
                   <div class="header__top">
                       <div class="tel">
                           <a href="tel:0000000000">+62823 3990 7214 </a><br><a href=""> +65 9469 2597</a>
                       </div>
                       <div class="email">
       ...
       <div class="homepage_slider">
           <div class="slider-container">
              ...
              <div class="slider">
                ...
                <div class="slide slide-{{ !empty($i) ? ++$i : $i = 0 }} active">
                  <div class="slide__bg" style="background-image: url({{asset('uploads/'.$destination->foto)}});"></div>
                   ...
                   <div class="most_popular__section__slider" id="most_popular__slider">
                       <a href="single.html" class="slider_item" style="background-image: url({{asset('assets')}}/img/onedaytrip.jpg)">
                           <div class="slider_item__content">
                               ...
                               <p class="description">
                                6 Destinations in one day start from 06 am - 04 pm
                               </p>
                               <!-- <div class="days">
                                   <span>7 days</span>
                               </div> -->
                       ...
                       <a href="single.html" class="slider_item" style="background-image: url({{asset('assets')}}/img/slide1.jpg)">
                           ...
                           <div class="slider_item__content">
                               ...
                               <p class="description">
                                3 + 6 Destinations in two days - 1 night stay at hotel start from 11 am
                               </p>
                               <!-- <div class="days">
                                   <span>23 days</span>
                               </div> -->
                       ...
                       <a href="single.html" class="slider_item" style="background-image: url({{asset('assets')}}/img/prevput3.jpg)">
                           <!-- <div class="slider_item__tags">
                               <div class="tag discount">20% off</div>
                           </div> -->
                           <div class="slider_item__content">
                               ...
                               <h3 class="title">
                                   Three Days Trip | from $550
                               </h3>
                               <p class="description">
                                10 Destinations in three days - 2 nights live on board start from 10 am.
                               </p>
                               <div class="days">
                                   <span>7 days</span>
                               </div>
                       ...
                       <!-- <a href="single.html" class="slider_item" style="background-image: url(img/prevput4.jpg)">
                           <div class="slider_item__tags">
                               <div class="tag discount">20% off</div>
                           </div>
                           <div class="slider_item__content">
                       ...
                       <a href="single.html" class="slider_item" style="background-image: url(img/prevput5.jpg)">
                           <div class="slider_item__tags">
                               <div class="tag discount">20% off</div>
               ...
               <div class="wrap">
                   <div class="wrap_float">
                       <div class="footer_center_left">
                           <a href="index.html" class="logo">DOV</a>
                           <div class="text">
                               Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.
                           </div>
                       </div>
